...
## [2026-06-22] lint | file md vuoti — rimosso orfano "legge di Amdahl.md" (root, 0 byte, untracked); corretto wikilink invertito in [[multiprocessing]] riga 120 ([[legge di Amdahl|concorrenza-parallelismo]] → [[concorrenza-parallelismo|legge di Amdahl]]) che generava il file vuoto. Amdahl già coperto in [[concorrenza-parallelismo]], nessuna pagina nuova. Verificato: nessun altro md vuoto fuori da .trash, nessun altro link invertito.
